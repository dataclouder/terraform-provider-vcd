		...
		Steps: []resource.TestStep{
			resource.TestStep{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckTypeSetElemAttr("vcd_edgegateway.egw", "external_network.*", "any"),
					...
					// }),
					resource.TestCheckTypeSetElemAttr("vcd_edgegateway.egw", "external_network.*.subnet.#", "1"),
					...
					resource.TestCheckTypeSetElemNestedAttrs("vcd_edgegateway.egw", "external_network.*.subnet.*.suballocate_pool.*", map[string]string{
